...
"""
    ...
    OR :         run /nobackupp19/aachary2/ayan_codes/foggie_craft/submit_jobs.py --call make_3D_FRB_electron_density --system ayan_pleiades --halo 8508 --queue ldan --mem 1500GB --prefix cmzs --opt_args "--res 1 --upto_kpc 10 --output RD0027 --docomoving --clobber --plot_3d"
                 run /nobackupp19/aachary2/ayan_codes/foggie_craft/submit_jobs.py --call make_3D_FRB_electron_density --system ayan_pleiades --do_all_halos --queue ldan --mem 1500GB --prefix cmzs --opt_args "--res 1 --upto_kpc 10 --output RD0027,RD0042 --docomoving"
"""
