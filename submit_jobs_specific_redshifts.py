...
"""
    ...
    Started :    July 2021
                 ...
                 run submit_jobs_specific_redshifts.py --call make_3D_FRB_electron_density --system ayan_pleiades --do_all_halos --queue ldan --mem 1500GB --prefix m3fed --do_redshifts 1.9,1.7,1.5,1.3,1.1,0.9,0.7,0.5,0.3,0.1 --opt_args "--res 0.5 --upto_kpc 200 --use_cen_smoothed"
"""
