...
"""
    ...
    Title :      plot_projected_gas_density
    Notes :      Plot PROJECTED gas density for given snapshot/s, in face-on and edge-on orientations in one plot
    Output :     Combined plots as png files
    Author :     Ayan Acharyya
    Started :    03 Feb 2026
    Examples :   run plot_projected_gas_density.py --system ayan_pleiades --halo 8508 --upto_kpc 200 --res 0.5 --docomoving --do_all_sims
                 run plot_projected_gas_density.py --system ayan_local --halo 8508 --upto_kpc 200 --res 0.5 --output RD0027 --docomoving
"""
from header import *
