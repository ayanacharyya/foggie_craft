...
##### Execute Program #####
top -b -u $USER -n 259200 1>top_ldan_gmsfr.out &
mpiexec -n 16 python /nobackupp19/aachary2/foggie_craft/foggie_craft/get_mass_sfr.py --system ayan_pleiades 1>output_ldan_gmsfr.out 2>&1
killall 'top'